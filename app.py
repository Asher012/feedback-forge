...
def show_navigation():
    ...
    <div class="main-nav">
        <div class="nav-container">
            ...
            <div class="nav-links">
                <span class="nav-link {'active' if st.session_state.page == 'home' else ''}" onclick="navigate_to('home')">Home</span>
                <span class="nav-link {'active' if st.session_state.page == 'about' else ''}" onclick="navigate_to('about')">About</span>
                <span class="nav-link {'active' if st.session_state.page == 'analysis' else ''}" onclick="navigate_to('analysis')">Analysis</span>
            </div>
        </div>
    </div>
    """, unsafe_allow_html=True)
...
if st.session_state.page == 'home':
    ...
    <div class="hero-section">
        ...
        <div>
            ...
            <button class="secondary-button" onclick="navigate_to('about')">Learn More</button>
        </div>
    </div>
    """, unsafe_allow_html=True)
    
    if st.button("", key="hidden_start"):
        st.session_state.comparison_mode = False
    ...
    with st.container():
        ...
        if st.session_state.comparison_mode:
            ...
            with col1:
                ...
                url_a = st.text_area("Google Play Store URL", placeholder="https://play.google.com/store/apps/details?id=...", height=100, key="url_a")
            
            with col2:
                st.markdown("**Second App**")
                url_b = st.text_area("Google Play Store URL", placeholder="https://play.google.com/store/apps/details?id=...", height=100, key="url_b")
        else:
            st.markdown("### App Analysis")
            url_a = st.text_area("Google Play Store URL", placeholder="https://play.google.com/store/apps/details?id=...", height=100)
            url_b = None
...
<div class="footer">
    <div class="footer-content">
        ...
        <p class="footer-text">
            Built with care for developers and product managers who want to understand their users better.
        </p>
    </div>
</div>
""", unsafe_allow_html=True)