...
# Navigation buttons (functional but styled to be invisible)
...
with col2:
    if st.button("nav_analysis", key="nav_analysis"):
        navigate_to('analysis')

with col3:
    if st.button("nav_dashboard", key="nav_dashboard"):
        navigate_to('dashboard')

with col4:
    if st.button("nav_about", key="nav_about"):
        navigate_to('about')

with col5:
    if st.button("nav_help", key="nav_help"):
        navigate_to('help')
...
/* Make navigation buttons invisible but functional */
...
""", unsafe_allow_html=True)section">
