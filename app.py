...
with col1:
    if st.button("🏠", key="nav_home_btn", help="Home"):
        navigate_to('home')
with col2:
    if st.button("📖", key="nav_about_btn", help="About"):
        navigate_to('about')
with col3:
    if st.button("📊", key="nav_analysis_btn", help="Analysis"):
        navigate_to('analysis')
...
if st.session_state.page == 'home':
    ...
    with col1:
        if st.button("Start Analysis", type="primary", key="start_analysis_home"):
            st.session_state.comparison_mode = False
            navigate_to('analysis')
...
# ANALYSIS PAGE
    ...
    with st.container():
        ...
        with col2:
            if st.button("Compare Two Apps", key="compare_btn"):
...
<div class="footer">
    <div class="footer-content">
        ...
        <p class="footer-text" style="margin-top: 16px; font-weight: 500; color: #1a8917;">
